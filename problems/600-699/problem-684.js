 ...
 *
 * This should call add on the initial value with the first element of the array, and then the result of that with the
 * second element of the array, and so on until we reach the end, when we return the sum of the array.
 *
