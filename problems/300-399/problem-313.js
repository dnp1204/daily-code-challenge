 ...
 * initially set to 000, a target combination, and a list of dead ends, write a function that returns the
 * minimum number of moves required to reach the target state, or None if this is impossible.
 * TODO:
 */
