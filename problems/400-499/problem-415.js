 ...
 * that calculates the maximum profit you could have made from buying and selling that stock. You're also given
 * a number fee that represents a transaction fee for each buy and sell transaction.
 *
 * You must buy before you can sell the stock, but you can make as many transactions as you like.
 *
 * For example, given [1, 3, 2, 8, 4, 10] and fee = 2, you should return 9, since you could buy the stock at 1dollar,
