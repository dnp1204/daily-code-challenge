 ...
 * after which the heights decrease by one. In addition, the start and end stones of the pyramid should
 * each be one stone high.
 *
 * You can change the height of any stone by paying a cost of 1 unit to lower its height by 1, as many
 * times as necessary. Given this information, determine the lowest cost method to produce this pyramid.
 *
